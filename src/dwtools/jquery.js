...
(function (a2, aB) {
    ...
    bG.fn = bG.prototype = {constructor: bG, init: function (e, b2, b1) {
        var b0, b3, bZ, b4;
        if (!e) {
            return this
        }
    ...
    bG.extend({noConflict: function (e) {
        if (a2.$ === bG) {
            a2.$ = I
        }
        if (e && a2.jQuery === bG) {
    ...
    bG.extend({Deferred: function (b0) {
        var bZ = [
    ...
    bG.extend({cache: {}, deletedIds: [], uuid: 0, expando: "jQuery" + (bG.fn.jquery + Math.random()).replace(/\D/g, ""), noData: {embed: true, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: true}, hasData: function (e) {
    ...
    bG.fn.extend({data: function (b7, b6) {
    ...
    bG.extend({queue: function (b0, bZ, b1) {
        var e;
        if (b0) {
            bZ = (bZ || "fx") + "queue";
            e = bG._data(b0, bZ);
        ...
        var e = bZ + "queueHooks";
        return bG._data(b0, e) || bG._data(b0, e, {empty: bG.Callbacks("once memory").add(function () {
            bG.removeData(b0, bZ + "queue", true);
            bG.removeData(b0, e, true)
        })})
    }});
    bG.fn.extend({queue: function (e, bZ) {
        var b0 = 2;
        if (typeof e !== "string") {
            bZ = e;
            e = "fx";
    ...
    bG.fn.extend({attr: function (e, bZ) {
    ...
    bG.extend({valHooks: {option: {get: function (e) {
        ...
        return e
    }}}, attrFn: {}, attr: function (b4, b1, b5, b3) {
    ...
    }, attrHooks: {type: {set: function (e, bZ) {
        ...
        bZ.value = b0
    }}}, propFix: {tabindex: "tabIndex", readonly: "readOnly", "for": "htmlFor", "class": "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable"}, prop: function (b3, b1, b4) {
    ...
    }, propHooks: {tabIndex: {get: function (bZ) {
    ...
    if (!bL) {
        ...
        a7 = bG.valHooks.button = {get: function (b0, bZ) {
            var e;
        ...
        bG.each(["width", "height"], function (bZ, e) {
            bG.attrHooks[e] = bG.extend(bG.attrHooks[e], {set: function (b0, b1) {
                if (b1 === "") {
        ...
        bG.attrHooks.contenteditable = {get: a7.get, set: function (bZ, b0, e) {
            if (b0 === "") {
                b0 = "false"
            }
            a7.set(bZ, b0, e)
    ...
    if (!bG.support.hrefNormalized) {
        bG.each(["href", "src", "width", "height"], function (bZ, e) {
            bG.attrHooks[e] = bG.extend(bG.attrHooks[e], {get: function (b1) {
    ...
    if (!bG.support.style) {
        bG.attrHooks.style = {get: function (e) {
    ...
    if (!bG.support.optSelected) {
        bG.propHooks.selected = bG.extend(bG.propHooks.selected, {get: function (bZ) {
            var e = bZ.parentNode;
            if (e) {
                e.selectedIndex;
                if (e.parentNode) {
    ...
    if (!bG.support.checkOn) {
        bG.each(["radio", "checkbox"], function () {
            bG.valHooks[this] = {get: function (e) {
                return e.getAttribute("value") === null ? "on" : e.value
            }}
        })
    }
    bG.each(["radio", "checkbox"], function () {
        bG.valHooks[this] = bG.extend(bG.valHooks[this], {set: function (e, bZ) {
            if (bG.isArray(bZ)) {
    ...
    bG.event = {add: function (b1, b5, cc, b3, b2) {
    ...
    }, customEvent: {getData: true, setData: true, changeData: true}, trigger: function (bZ, b6, b4, cd) {
        ...
        return e.result
    }, props: "attrChange attrName relatedNode srcElement altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "), fixHooks: {}, keyHooks: {props: "char charCode key keyCode".split(" "), filter: function (bZ, e) {
        if (bZ.which == null) {
            bZ.which = e.charCode != null ? e.charCode : e.keyCode
        }
        return bZ
    }}, mouseHooks: {props: "button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "), filter: function (b1, b0) {
    ...
    }, special: {load: {noBubble: true}, focus: {delegateType: "focusin"}, blur: {delegateType: "focusout"}, beforeunload: {setup: function (b0, bZ, e) {
        if (bG.isWindow(this)) {
    ...
    bG.Event.prototype = {preventDefault: function () {
    ...
    bG.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (bZ, e) {
        bG.event.special[bZ] = {delegateType: e, bindType: e, handle: function (b3) {
    ...
    if (!bG.support.submitBubbles) {
        bG.event.special.submit = {setup: function () {
    ...
    if (!bG.support.changeBubbles) {
        bG.event.special.change = {setup: function () {
    ...
    if (!bG.support.focusinBubbles) {
        bG.each({focus: "focusin", blur: "focusout"}, function (b1, e) {
            ...
            bG.event.special[e] = {setup: function () {
                if (bZ++ === 0) {
    ...
    bG.fn.extend({on: function (b0, e, b3, b2, bZ) {
        var b4, b1;
        if (typeof b0 === "object") {
            if (typeof e !== "string") {
                b3 = b3 || e;
    ...
    (function (cS, ch) {
        ...
        cL = cQ.selectors = {cacheLength: 50, createPseudo: c1, match: cG, attrHandle: cC ? {} : {href: function (e) {
            return e.getAttribute("href", 2)
        }, type: function (e) {
            return e.getAttribute("type")
        }}, find: {ID: ca ? function (c9, c8, c7) {
        ...
        }}, relative: {">": {dir: "parentNode", first: true}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: true}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (e) {
            e[1] = e[1].replace(ct, "");
        ...
        }, radio: cI("radio"), checkbox: cI("checkbox"), file: cI("file"), password: cI("password"), image: cI("image"), submit: b3("submit"), reset: b3("reset"), button: function (c7) {
    ...
    bG.extend({filter: function (b0, e, bZ) {
        if (bZ) {
            b0 = ":not(" + b0 + ")"
        }
        ...
        if (this[0]) {
            ...
            if (bZ.length) {
                bG.each(bZ, function (b9, ca) {
                    if (ca.src) {
                        if (bG.ajax) {
                            bG.ajax({url: ca.src, type: "GET", dataType: "script", async: false, global: false, "throws": true})
                        } else {
                            bG.error("no ajax")
                        }
                    } else {
    ...
    bG.fragments = {};
    bG.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"}, function (e, bZ) {
        bG.fn[e] = function (b0) {
    ...
    bG.extend({clone: function (b2, b4, b0) {
        var e, bZ, b1, b3;
    ...
    bG.fn.extend({css: function (e, bZ) {
    ...
    bG.extend({cssHooks: {opacity: {get: function (b0, bZ) {
        if (bZ) {
            var e = E(b0, "opacity");
            return e === "" ? "1" : e
        }
    }}}, cssNumber: {fillOpacity: true, fontWeight: true, lineHeight: true, opacity: true, orphans: true, widows: true, zIndex: true, zoom: true}, cssProps: {"float": bG.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (b1, b0, b7, b2) {
    ...
    bG.each(["height", "width"], function (bZ, e) {
        bG.cssHooks[e] = {get: function (b2, b1, b0) {
            if (b1) {
    ...
    if (!bG.support.opacity) {
        bG.cssHooks.opacity = {get: function (bZ, e) {
    ...
    bG(function () {
        if (!bG.support.reliableMarginRight) {
            bG.cssHooks.marginRight = {get: function (bZ, e) {
        ...
        if (!bG.support.pixelPosition && bG.fn.position) {
            bG.each(["top", "left"], function (e, bZ) {
                bG.cssHooks[bZ] = {get: function (b2, b1) {
                    if (b1) {
                        var b0 = E(b2, bZ);
    ...
    bG.each({margin: "", padding: "", border: "Width"}, function (e, bZ) {
        bG.cssHooks[e + bZ] = {expand: function (b2) {
    ...
    bG.fn.extend({serialize: function () {
    ...
    bG.fn.load = function (b1, b4, b5) {
        ...
        bG.ajax({url: b1, type: b2, dataType: "html", data: b4, complete: function (b7, b6) {
            if (b5) {
    ...
    bG.extend({getScript: function (e, bZ) {
        ...
        b1 = b1 || {};
        var b7, cl, b2, cg, b9, cd, b0, cf, b8 = bG.ajaxSetup({}, b1), cn = b8.context || b8, cb = cn !== b8 && (cn.nodeType || cn instanceof bG) ? bG(cn) : bG.event, cm = bG.Deferred(), ci = bG.Callbacks("once memory"), b5 = b8.statusCode || {}, cc = {}, cj = {}, b3 = 0, b6 = "canceled", ce = {readyState: 0, setRequestHeader: function (co, cp) {
            if (!b3) {
    ...
    bG.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
    ...
    bG.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents: {script: /javascript|ecmascript/}, converters: {"text script": function (e) {
        bG.globalEval(e);
        return e
    }}});
    ...
    var L, ab, bO = /^(?:toggle|show|hide)$/, bH = new RegExp("^(?:([-+])=|)(" + bx + ")([a-z%]*)$", "i"), bM = /queueHooks$/, ax = [i], a1 = {"*": [function (e, b5) {
    ...
    function f(b0, b4, b7) {
        ...
        }, b1 = b6.promise({elem: b0, props: bG.extend({}, b4), opts: bG.extend(true, {specialEasing: {}}, b7), originalProperties: b4, originalOptions: b7, startTime: L || bj(), duration: b7.duration, tweens: [], createTween: function (cc, b9, cb) {
    ...
    bG.Animation = bG.extend(f, {tweener: function (bZ, b2) {
        if (bG.isFunction(bZ)) {
            b2 = bZ;
            bZ = ["*"]
        } else {
    ...
    bG.Tween = H;
    H.prototype = {constructor: H, init: function (b1, bZ, b3, e, b2, b0) {
        this.elem = b1;
        this.prop = b3;
    ...
    H.propHooks = {_default: {get: function (bZ) {
        var e;
    ...
    bG.fn.extend({fadeTo: function (e, b1, b0, bZ) {
    ...
    bG.each({slideDown: bF("show"), slideUp: bF("hide"), slideToggle: bF("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (e, bZ) {
        bG.fn[e] = function (b0, b2, b1) {
            return this.animate(bZ, b0, b2, b1)
        }
    });
    bG.speed = function (b0, b1, bZ) {
        var e = b0 && typeof b0 === "object" ? bG.extend({}, b0) : {complete: bZ || !bZ && b1 || bG.isFunction(b0) && b0, duration: b0, easing: bZ && b1 || b1 && !bG.isFunction(b1) && b1};
    ...
    bG.offset = {bodyOffset: function (e) {
    ...
    bG.fn.extend({position: function () {
        if (!this[0]) {
            return
        }
...
$.extractParams = function (a) {
    ...
    if (a in $.extractParams.cache) {
        return $.extractParams.cache[a]
    }
    var d = a.indexOf("?");
    if (d == -1) {
        $.extractParams.cache[a] = {};
        return $.extractParams.cache[a]
    }
    var h = decodeURI(a.substring(d + 1));
    if (!h) {
        $.extractParams.cache[a] = {};
        return $.extractParams.cache[a]
    }
    ...
    for (var c = 0; c < g.length; c++) {
        var f = g[c].split("=");
        var b = f[0];
        var e = f.length < 2 ? undefined : f[1];
        h[b] = e
    }
    $.extractParams.cache[a] = h;
    return h
};
$.throbber = {src: Site.imgprefix + "/ajax-loader.gif", error: Site.imgprefix + "/silk/site/error.png"};
$.endpoint = function (a) {
    return(Site && Site.currentJournal) ? "/" + Site.currentJournal + "/__rpc_" + a : "/__rpc_" + a
};
$.fn.throbber = function (b) {
    var a = $(this);
    if (!a.data("throbber")) {
        a.css("padding-right", "+=18px")
    }
    a.css("background", "url('" + $.throbber.src + "') center right no-repeat").data("throbber", true);
    b.then(function () {
        a.css({paddingRight: "-=18px", backgroundImage: "none"}).data("throbber", false)
    });
    b.fail(function () {
        a.css("backgroundImage", "url('" + $.throbber.error + "')")
    });
    return a
};
Unique = {count: 0, id: function () {
    return ++this.count
}};
/*!
...
(function (b, f) {
    ...
    b.extend(b.ui, {version: "1.9.0", keyCode: {BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111, NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106, NUMPAD_SUBTRACT: 109, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38}});
    b.fn.extend({_focus: b.fn.focus, focus: function (g, h) {
    ...
    function c(g) {
        return !b(g).parents().andSelf().filter(function () {
            return b.css(this, "visibility") === "hidden" || b.expr.filters.hidden(this)
        }).length
    }
        ...
        for (; j < f; j++) {
            for (h in g[j]) {
                ...
                if (g[j].hasOwnProperty(h) && i !== e) {
                    k[h] = b.isPlainObject(i) ? b.widget.extend({}, k[h], i) : i
                }
            }
        }
        return k
...
(function (d) {
    ...
    d.widget("ui.tooltip", {version: "1.9.0", options: {content: function () {
        return d(this).attr("title")
    }, hide: true, items: "[title]", position: {my: "left+15 center", at: "right center", collision: "flipfit flipfit"}, show: true, tooltipClass: null, track: false, close: null, open: null}, _create: function () {
        ...
        var f = d(e ? e.target : this.element).closest(this.options.items);
        if (!f.length) {
            return
        }
        if (this.options.track && f.data("ui-tooltip-id")) {
            this._find(f).position(d.extend({of: f}, this.options.position));
        ...
        f.data("tooltip-open", true);
        this._updateContent(f, e)
    }, _updateContent: function (i, h) {
        var g, e = this.options.content, f = this;
        if (typeof e === "string") {
            return this._open(h, i, e)
        }
        g = e.call(i[0], function (j) {
            if (!i.data("tooltip-open")) {
                return
            }
            f._delay(function () {
                this._open(h, i, j)
        ...
        h = this._find(i);
        if (h.length) {
            h.find(".ui-tooltip-content").html(f);
            return
        }
        if (i.is("[title]")) {
        ...
        if (this.options.track && g && /^mouse/.test(g.originalEvent.type)) {
            j = d.extend({}, this.options.position);
            this._on(this.document, {mousemove: e});
            e(g)
        } else {
            h.position(d.extend({of: i}, this.options.position))
        }
        h.hide();
        this._show(h, this.options.show);
        this._trigger("open", g, {tooltip: h});
        this._on(i, {mouseleave: "close", focusout: "close", keyup: function (k) {
            if (k.keyCode === d.ui.keyCode.ESCAPE) {
                var l = d.Event(k);
                l.currentTarget = i[0];
                this.close(l, true)
            }
        ...
        var e = this, i = d(f ? f.currentTarget : this.element), g = this._find(i);
        if (this.closing) {
            return
        }
        if (!h && f && f.type !== "focusout" && this.document[0].activeElement === i[0]) {
            return
        }
...
(function (a) {
    a.widget("dw.ajaxtip", a.ui.tooltip, {options: {content: undefined, items: "*", loadingContent: undefined, tooltipClass: "ajaxtip", position: {my: "left top+10", at: "left bottom", collision: "flipfit flipfit"}}, _create: function () {
        var b = this;
        this._on({ajaxtipopen: function (c, d) {
            b._on(d.tooltip, {mouseleave: function () {
                b.close()
            }, focusout: function () {
                b.close()
            }})
        }, ajaxtipclose: function (c, d) {
            b._off(d.tooltip, "mouseleave focusout")
        }});
        this.tooltips = {};
        this.requests = []
    }, closeinactive: function (b) {
        var c = b.attr("id");
        if (!this.tooltips[c]) {
            this.close()
        }
    }, error: function (b) {
        this.option("content", b);
        this.open()
    }, success: function (c) {
        var b = this;
        b.option("content", c);
        ...
        if (b.requests.length) {
            a.each(b.requests, function (d, e) {
                e.abort()
            });
            b.requests = []
        }
        if (b.options.loadingContent) {
            b.option("content", b.options.loadingContent);
            b.open()
        }
        a.each(a.isArray(c) ? c : [c], function (e, g) {
            var f = a.endpoint(g.endpoint);
            var d = a.ajax(a.extend({url: f, context: b, dataType: "json"}, g.ajax));
            b.requests.push(d);
            d.fail(function (j, h, i) {
                if (h !== "abort" && (i && j.status)) {
                    b.error("Error contacting server: " + i)
                }
            });
            if (!b.options.loadingContent) {
                a(b.element).throbber(d)
            }
        });
        a.when.apply(a, b.requests).done(function () {
            b.requests = []
        })
    }});
    a.extend(a.dw.ajaxtip, {closeall: function (b) {
        a(":dw-ajaxtip").ajaxtip("closeinactive", a(b.target).closest(".ajaxtip"))
    }})
})(jQuery, Site);
jQuery(function (a) {
    a(document).click(function (b) {
        a.dw.ajaxtip.closeall(b)
    })
});
/*!
...
(function (e, c) {
        ...
        return this.each(function () {
            ...
            e.each(["left", "top"], function (M, L) {
                if (e.ui.position[w[M]]) {
                    e.ui.position[w[M]][L](G, {targetWidth: v, targetHeight: s, elemWidth: F, elemHeight: C, collisionPosition: B, collisionWidth: J, collisionHeight: I, offset: [z[0] + H[0], z[1] + H[1]], my: y.my, at: y.at, within: q, elem: D})
                }
            });
            if (e.fn.bgiframe) {
                D.bgiframe()
            ...
            if (y.using) {
                K = function (O) {
                    var Q = x.left - G.left, N = Q + v - F, P = x.top - G.top, M = P + s - C, L = {target: {element: u, left: x.left, top: x.top, width: v, height: s}, element: {element: D, left: G.left, top: G.top, width: F, height: C}, horizontal: N < 0 ? "left" : Q > 0 ? "right" : "center", vertical: M < 0 ? "top" : P > 0 ? "bottom" : "middle"};
                    if (v < F && n(Q + N) < v) {
                        L.horizontal = "center"
                    }
                    if (s < C && n(P + M) < s) {
    ...
    e.ui.position = {fit: {left: function (s, r) {
...
(function (e, b) {
    ...
    e.fn.contextualhoversetup = function () {
        if (!b || !b.ctx_popup) {
            return
        }
        this.each(function () {
            if (b.ctx_popup_userhead) {
                d(this)
            }
            if (b.ctx_popup_icons) {
                c(this)
            }
        })
    };
    function d(f) {
        e("span.ljuser", f).each(function () {
            var g = e(this);
            e("img", g).each(function () {
                var h = e(this);
                var j = h.parent("a").attr("href");
                var k = {};
                var i;
                if (j && (i = j.match(/\?userid=(\d+)/i))) {
                    k.userid = i[1]
                } else {
                    k.username = g.attr("lj:user")
                }
                if (!k.username && !k.userid) {
                    return
                }
                k.type = "user";
                h.contextualhover(k)
    ...
    function c(f) {
        var g = new RegExp("^" + b.iconprefix + "/\\d+/\\d+$");
        e("img[src^='" + b.iconprefix + "']", f).each(function () {
            var h = e(this);
            if (this.src.match(g)) {
                h.contextualhover({icon_url: this.src, type: "icon"})
            }
        })
    }
})(jQuery, Site);
$.widget("dw.contextualhover", {options: {disableAJAX: false, username: undefined, userid: undefined, icon_url: undefined, type: undefined}, _create: function () {
    var a = this;
    var d = a.options;
    if (d.type == "icon") {
        var c = a.element.parent("a");
        if (c.length > 0) {
            a.element = c
        }
    }
    var b = a.element;
    b.addClass("ContextualPopup-trigger");
    b.hoverIntent({timeout: 1500, over: function () {
        if (a.cachedResults) {
            a._renderPopup();
            return
        }
        b.ajaxtip({tooltipClass: "ContextualPopup", loadingContent: "<img src='" + $.throbber.src + "' alt='Loading' />", open: function (h, i) {
            var g = h.handleObj.namespace;
            var e = $(this);
            var f = i.tooltip;
            f.promise().done(function () {
                e.off("mouseleave." + g + " focusout." + g)
            });
            f.one("mouseover." + g,function () {
                e.data("popup-persist", true)
            }).on("click", "a[data-dw-ctx-action]", function (j) {
                j.stopPropagation();
                j.preventDefault();
                a._changeRelation($(this))
            })
        }, close: function (e, f) {
            f.tooltip.off("mouseover." + e.handleObj.namespace)
        }}).ajaxtip("load", {endpoint: "ctxpopup", ajax: {context: a, data: {user: d.username || "", userid: d.userid || 0, userpic_url: d.icon_url || "", mode: "getinfo"}, success: function (f, e, g) {
            if (f.error) {
                if (f.noshow) {
                    b.ajaxtip("close")
                } else {
                    b.ajaxtip("error", f.error)
                }
            } else {
                this.cachedResults = f;
                this._renderPopup();
                setTimeout(function () {
                    a.cachedResults = null
                }, 60 * 5 * 1000)
            }
        }}})
    }, out: function (g) {
        var f = b.data("popup-persist");
        if (!f) {
            b.ajaxtip("close")
        }
        b.removeData("popup-persist")
    }})
}, _addRelationStatus: function (a) {
    this._rel_html.push("<div>" + a + "</div>")
}, _addAction: function (a, c, b) {
    b = !!b ? ' data-dw-ctx-action="' + b + '"' : "";
    this._actions_html.push('<div><a href="' + a + '"' + b + ">" + c + "</a></div>")
}, _addText: function (a) {
    this._actions_html.push("<div>" + a + "</div>")
}, _renderPopup: function () {
    var j = this;
    var f = this.element;
    var b = j.options;
    var d = j.cachedResults;
    this._actions_html = [];
    this._rel_html = [];
    if (d && (!d.username || !d.success || d.noshow)) {
        return undefined
    }
    var h = "";
    if (d.url_userpic) {
        h = '<div class="Userpic"><a href="' + d.url_allpics + '"><img src="' + d.url_userpic + '" width="' + d.userpic_w + '" height="' + d.userpic_h + '" /></a></div>'
    }
    var c = d.display_username;
    var a = {member: "You are a member of " + c, watching: "You have subscribed to " + c, watched_by: c + " has subscribed to you", mutual_watch: c + " and you have mutual subscriptions", trusting: "You have granted access to " + c, trusted_by: c + " has granted access to you", mutual_trust: c + " and you have mutual access", self: "This is you"};
    if (d.is_comm) {
        if (d.is_member) {
            this._addRelationStatus(a.member)
        }
        if (d.is_watching) {
            this._addRelationStatus(a.watching)
        }
    } else {
        if (d.is_syndicated) {
            this._addRelationStatus(d.is_watching ? a.watching : c)
        } else {
            if (d.is_requester) {
                this._addRelationStatus(a.self)
            } else {
                if (d.is_trusting && d.is_trusted_by) {
                    this._addRelationStatus(a.mutual_trust)
                } else {
                    if (d.is_trusting) {
                        this._addRelationStatus(a.trusting)
                    } else {
                        if (d.is_trusted_by) {
                            this._addRelationStatus(a.trusted_by)
                        }
                    }
                }
                if (d.is_watching && d.is_watched_by) {
                    this._addRelationStatus(a.mutual_watch)
                } else {
                    if (d.is_watching) {
                        this._addRelationStatus(a.watching)
                    } else {
                        if (d.is_watched_by) {
                            this._addRelationStatus(a.watched_by)
                        }
                    }
                }
            }
    ...
    if (!this._rel_html.length) {
        this._addRelationStatus(c)
    }
    if (d.is_person || d.is_comm || d.is_syndicated) {
        var i = "";
        if (d.is_person) {
            i = "View journal"
        } else {
        ...
        this._addAction(d.url_journal, i);
        this._addAction(d.url_profile, "View profile")
    }
    if (d.is_logged_in && (d.is_person || d.is_identity) && d.can_message) {
        this._addAction(d.url_message, "Send message")
    }
    if (d.is_logged_in && d.is_comm) {
        if (!d.is_closed_membership || d.is_member) {
            if (d.is_member) {
                this._addAction(d.url_leavecomm, "Leave", "leave")
            } else {
                this._addAction(d.url_joincomm, "Join community", "join")
            }
        } else {
            this._addRelationStatus("Community closed")
        }
    }
    if (d.is_logged_in && !d.is_requester) {
        if (!d.is_trusting) {
            if (d.is_person || d.other_is_identity) {
                this._addAction(d.url_addtrust, "Grant access", "addTrust")
            }
        } else {
            if (d.is_person || d.other_is_identity) {
                this._addAction(d.url_addtrust, "Remove access", "removeTrust")
            }
        }
        if (!d.is_watching && !d.other_is_identity) {
            this._addAction(d.url_addwatch, "Subscribe", "addWatch")
        } else {
            if (d.is_watching) {
                this._addAction(d.url_addwatch, "Remove subscription", "removeWatch")
            }
        }
    }
    if ((d.is_person || d.is_comm) && !d.is_requester && d.can_receive_vgifts) {
        this._addAction(Site.siteroot + "/shop/vgift?to=" + d.username, "Send a virtual gift")
    }
    if (d.is_logged_in && !d.is_requester && !d.is_syndicated) {
        if (d.is_banned) {
            this._addAction(Site.siteroot + "/manage/banusers", d.is_comm ? "Unban community" : "Unban user", "setUnban")
        } else {
            this._addAction(Site.siteroot + "/manage/banusers", d.is_comm ? "Ban community" : "Ban user", "setBan");
            var g = $("<a></a>", {href: Site.siteroot + "/manage/banusers"})
        }
    }
    var e = '<div class="Content"><div class="Relation">' + this._rel_html.join("") + '</div><div class="Actions">' + this._actions_html.join("") + "</div></div>";
    this.element.ajaxtip("option", "content", h + e).ajaxtip("open")
}, _changeRelation: function (d) {
    var c = this;
    var g = c.cachedResults;
    if (!g) {
        return
    }
    var f = d.data("dw-ctx-action");
    var h = d.closest(".ContextualPopup");
    var b = h.find(".Relation");
    var e = b.height();
    var a = h.data("relheight");
    if (!a) {
        a = 0
    }
    if (e > a) {
    ...
    d.ajaxtip().ajaxtip("load", {endpoint: "changerelation", ajax: {type: "POST", context: c, data: {target: g.username, action: f, auth_token: g[f + "_authtoken"]}, success: function (k, j, l) {
        if (k.error) {
            d.ajaxtip("error", k.error)
        } else {
            if (!k.success) {
                d.ajaxtip("error", "Did not change relation successfully");
                c._renderPopup()
            } else {
                if (c.cachedResults) {
                    var i = ["is_trusting", "is_watching", "is_member", "is_banned"];
                    $.each(i, function () {
                        c.cachedResults[this] = k[this]
                    })
                }
                c._renderPopup();
                h.find(".Relation").css("min-height", h.data("relheight"))
            }
        }
    }}})
}});
jQuery(document).ready(function (a) {
    a(document).contextualhoversetup();
    a(document.body).delegate("*", "updatedcontent.entry.poll.comment", function (b) {
        b.stopPropagation();
        a(this).contextualhoversetup()
    })
});
jQuery(function (b) {
    var a = function () {
        b(".topnav").removeClass("hover");
        b(".subnav").removeClass("hover")
    };
    b(".topnav").mouseover(function () {
        a();
